    ...
    for num, data in enumerate(verify_data):
        ...
        if str_label == 'bacterial':
            ...
            disease = tk.Label(text='Disease Name: ' + diseasename, background="lightgreen",
                               fg="Black", font=("", 15))
            disease.grid(column=1, row=4, padx=10, pady=10)
            r = tk.Label(text='Click below for remedies...', background="lightgreen", fg="Brown", font=("", 15))
            r.grid(column=1, row=5, padx=10, pady=10)
            ...
            r = tk.Label(text='Plant is healthy', background="lightgreen", fg="Black",
                         font=("", 15))
            r.grid(column=1, row=4, padx=10, pady=10)
            button = tk.Button(text="Exit", command=exit)
...
def openphoto():
    ...
    # C:/Users/user/Test/Project_nexgen/detection/plant disease/..... you can change it according to the image location you have  
